 ...
 *         &lt;element name="itemsToPrint" type="{https://dhl24.com.pl/webapi2/provider/service.html?ws=1}ArrayOfItemtoprint"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetLabels {
    ...
    @XmlElement(required = true, nillable = true)
    protected ArrayOfItemtoprint itemsToPrint;
     ...
     * @return
     *     possible object is
     *     {@link ArrayOfItemtoprint }
     *     
     */
    public ArrayOfItemtoprint getItemsToPrint() {
        return itemsToPrint;
    }
     ...
     *     
     */
    public void setItemsToPrint(ArrayOfItemtoprint value) {
