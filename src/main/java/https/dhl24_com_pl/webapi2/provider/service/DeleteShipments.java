 ...
 *         &lt;element name="shipments" type="{https://dhl24.com.pl/webapi2/provider/service.html?ws=1}ArrayOfString"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "deleteShipments")
public class DeleteShipments {

    @XmlElement(required = true, nillable = true)
    protected AuthData authData;
    @XmlElement(required = true, nillable = true)
    protected ArrayOfString shipments;
     ...
     *     
     */
    public ArrayOfString getShipments() {
        return shipments;
    }
     ...
     *     
     */
    public void setShipments(ArrayOfString value) {
